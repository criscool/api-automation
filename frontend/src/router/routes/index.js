...
export const basicRoutes = [
  ...
  // API 自动化工作流内部跳转的辅助页面（不展示在侧边菜单中）。
  // 与后端菜单表解耦，避免菜单数据缺失时跳转到 404。
  {
    ...
    children: [
      {
        ...
        component: () => import('@/views/api-automation/analysis-detail/index.vue'),
        isHidden: true,
        meta: { title: '分析详情', icon: 'mdi:chart-line' },
      },
      {
        name: 'ScriptPreview',
        path: 'script-preview',
        component: () => import('@/views/api-automation/script-preview/index.vue'),
        isHidden: true,
